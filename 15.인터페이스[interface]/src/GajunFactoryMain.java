...
public class GajunFactoryMain {
	...
	public static void main(String[] args) {
		...
		GajunOnOff[] gajunArray =new GajunOnOff[5];// 인터페이스도 배열객체는 만들 수 있다.(물론 인터페이스는 객체 못만듦)
		...
		for (int i = 0; i < receiveGajunArray.length; i++) {
			...
			GajunVolume tempGaun = (GajunVolume)receiveGajunArray[i]; // onOff타입을 volume타입으로 형변환해야함
			tempGaun.up();
			tempGaun.down();
